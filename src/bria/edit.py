...
from src.bria.constants import (
    IMAGE_KEY, PRESERVE_ALPHA_KEY, SYNC_KEY, VISUAL_INPUT_MODERATION_KEY,
    VISUAL_OUTPUT_MODERATION_KEY, RESULT_KEY, IMAGE_URL_KEY, STATUS_KEY, REQUEST_ID_KEY, STATUS_URL_KEY, BASE_URL, EDIT,
    REMOVE_BACKGROUND,
...
class Edit(Image):
    ...
    def _build_result(self, data: Dict[str, Any], is_sync: bool) -> Union[EditSyncResult, EditAsyncResult]:
